...
// Param {onVideoSelect}: The selected video property passed in. Using ES6 Syntax.
// Could have also just used, const onVideoSelect = props.onVideoSelect 
...
const VideoListItem = ({video, onVideoSelect}) => {
	...
	// When a user clicks anywhere on the list element, call the onVideoSelect function
	// passing in this video. 
