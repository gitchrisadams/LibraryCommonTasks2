...
class Account:
    # Static method that gets the UTC time and returns it.
    @staticmethod
    def _current_time():
    ...
    def deposit(self, amount):
        if amount > 0:
            ...
            # The static method _current_time() is used here.
    ...
    # Also append to transaction list along w/ amount as negative.
